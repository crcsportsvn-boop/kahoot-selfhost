        ...
        <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-8 space-y-8">
          ...
          {!loading && quizzes.length === 0 && (
            <div className="p-12 rounded-3xl bg-slate-900/60 border border-slate-800 text-center max-w-lg mx-auto space-y-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">{t.noQuizzesTitle}</h3>
              ...
              {quizzes.map((quiz) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Bottom Action: Only Play Live button, full width */}
                    <div className="pt-6 mt-6 border-t border-slate-800">
                      <button
                        onClick={() => handleStartGame(quiz.id)}
                        disabled={creatingSessionId === quiz.id}
                        className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-xs sm:text-sm font-black bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white shadow-lg shadow-emerald-700/20 disabled:opacity-50 transition cursor-pointer"
                      >
